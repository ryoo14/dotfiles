_deno() {
    ...
    case "${cmd}" in
        ...
        deno__bench)
            ...
            ;;
        deno__bundle)
            opts="-c -r -h -L -q --import-map --no-remote --no-config --config --no-check --check --reload --lock --lock-write --cert --watch --no-clear-screen --help --unstable --log-level --quiet <source_file> <out_file>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        deno__cache)
            opts="-c -r -h -L -q --import-map --no-remote --no-config --config --no-check --check --reload --lock --lock-write --cert --help --unstable --log-level --quiet <file>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        deno__check)
            opts="-c -r -h -L -q --import-map --no-remote --config --no-config --reload --lock --lock-write --cert --remote --help --unstable --log-level --quiet <file>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        deno__doc)
            ...
            ;;
        deno__eval)
            opts="-c -r -T -p -h -L -q --import-map --no-remote --no-config --config --no-check --check --reload --lock --lock-write --cert --inspect --inspect-brk --cached-only --location --v8-flags --seed --enable-testing-features-do-not-use --compat --ts --ext --print --help --unstable --log-level --quiet <CODE_ARG>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        deno__help)
            ...
            ;;
        deno__info)
            opts="-r -c -h -L -q --reload --cert --location --no-check --no-config --config --import-map --json --help --unstable --log-level --quiet <file>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        deno__install)
            ...
            ;;
        deno__lint)
            opts="-c -h -L -q --rules --rules-tags --rules-include --rules-exclude --no-config --config --ignore --json --watch --no-clear-screen --help --unstable --log-level --quiet <files>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        deno__lsp)
            ...
            ;;
        deno__repl)
            opts="-c -r -h -L -q --import-map --no-remote --no-config --config --no-check --check --reload --lock --lock-write --cert --inspect --inspect-brk --cached-only --location --v8-flags --seed --enable-testing-features-do-not-use --compat --eval-file --eval --unsafely-ignore-certificate-errors --help --unstable --log-level --quiet"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        deno__task)
            ...
            ;;
        deno__test)
            opts="-c -r -A -j -h -L -q --import-map --no-remote --no-config --config --no-check --check --reload --lock --lock-write --cert --allow-read --allow-write --allow-net --unsafely-ignore-certificate-errors --allow-env --allow-run --allow-ffi --allow-hrtime --allow-all --prompt --no-prompt --inspect --inspect-brk --cached-only --location --v8-flags --seed --enable-testing-features-do-not-use --compat --ignore --no-run --trace-ops --doc --fail-fast --allow-none --filter --shuffle --coverage --parallel --jobs --watch --no-clear-screen --help --unstable --log-level --quiet <files>... <SCRIPT_ARG>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
