...
vim.keymap.set('n', '<Space>lr', '<cmd>lua vim.lsp.buf.references()<CR>')
vim.keymap.set('n', '<Space>li', '<cmd>lua vim.lsp.buf.implementation()<CR>')
vim.keymap.set('n', '<Space>ln', '<cmd>lua vim.lsp.buf.rename()<CR>')
